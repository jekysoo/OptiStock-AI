...
def load_enterprise_data_v2():
    # Smart path routing for local drive vs web hosting environments
    ...
    # Ultra date parser utilizing regex pattern recognition to capture varying 1C string formats
...
if len(df_item) < 6:
    ...
    with tab1:
        # Step 1: Train Prophet to capture macro trend and global seasonality
        ...
        # Step 2: Advanced Feature Engineering for residual variance modeling
        ...
        # Step 3: Train XGBoost to learn pattern errors (residuals) missed by Prophet
        ...
        # Step 4: Iterative Out-of-Sample Forecasting loop into the 2026 horizon
        ...
        for i, row in future_dates_only.iterrows():
            ...
            final_pred = max(0, prophet_base + pred_residual) # Non-negative constraint enforcement
            future_forecast.append(final_pred)
            
            # Recursive state updates for subsequent lags
