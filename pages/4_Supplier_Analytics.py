...
st.markdown("Analysis of incoming invoices (Приходные накладные) to evaluate supplier dependency and inbound cash flow.")

@st.cache_data
def load_invoices():
    db_path = '/content/drive/MyDrive/Smart_inventory_project/Data/Processed/enterprise_database.db'
    conn = sqlite3.connect(db_path)
    # Load the table containing the delivery notes that we created in File 01
    try:
...
if df_invoices.empty:
    ...
    # Calculating each supplier’s percentage share
